...
Now, how does this compare to the average salary? For the business analyst, the top 2 companies are unchanged: University of Texas Administration and Officemax Incorporated. Data analyst has stayed pretty consistent with its top 5, just shifting around the rankings.

Let's try restricting the percentiles to see if this will change the top companies.
...
We do end up with changes in the samples and different companies when we restrict the percentiles. Business analyst, data analyst, and software engineer expanded; while data scientist and management consultant stayed the same. 

There is definitely a change in max salary for each one. Business analyst's went down 180 for 124,898 at Tesoro Companies Inc, data analyst went down 6,300 for 122,000 at UBS Services LLC, data scientist went down 80,200 for 124,800 at Edataforce Consulting LLC, management consultant went down 325,428.8 for 124571.2 at Dell USA LP, and software engineer went down 1,099,801 for 124999.9 at Zulily Inc. Software engineer had the greatest loss out of all the job sub types, yet it still makes more out of all of them. This is quite confounding admittedly, how software engineer is such an umbrella term.

#### c. Will the answer change if I take standard of living into account?

If I took the standard of living into account, my answer will change. 
