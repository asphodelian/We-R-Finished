...
Previously in Q2, I have used the average and max to answer it. Cost of living dataset does use averages to then make a baseline, so we will use averages to answer this question.
