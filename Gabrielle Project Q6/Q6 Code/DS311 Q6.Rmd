...
# new subset
salcost <- salcost[, c("EMPLOYER_NAME", "Job Title Sub", "Work State", "PAID_WAGE_PER_YEAR", "ADJUSTED_WAGE", "costIndex")]

# rename columns
colnames(salcost)[1] = "Employer"
colnames(salcost)[4] = "Paid Wage/Yr"
colnames(salcost)[5] = "Adjusted Wage"
colnames(salcost)[6] = "Cost Index"
head(salcost)
```
